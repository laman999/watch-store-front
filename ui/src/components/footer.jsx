    ...
    <>
      <footer className='bg-black w-full p-[45px] pt-16 pb-12'>
        <div className='container grid grid-cols-1 md:grid-cols-5 gap-12 text-white mx-auto'>
           ...
           <div className='flex flex-col gap-[8px]'>
            <h4 className="md:text-[14px] text-[12px] font-bold uppercase mb-[10px] text-white">{t('footer_collections')}</h4>
          ...
          <div className='flex flex-col gap-[8px]'>
            <h4 className="md:text-[14px] text-[12px] font-bold uppercase mb-[10px] text-white">{t('footer_support')}</h4>
            <ul className="md:text-[14px] text-[12px] text-gray-400 flex flex-col gap-[8px]">
          ...
          <div>
            <h4 className="md:text-[14px] text-[12px] font-bold uppercase mb-6 text-white">{t('footer_inspired')}</h4>
